(function() {
  ...
  const queryString = new jasmine.QueryString({getWindowLocation: ()=>{return window.location}})
  ...
  if (random !== undefined && random !== '')config.random = random
  ...
  config.specFilter = spec=>{return specFilter.matches(spec.getFullName())}
